...
export default function VendorProductsModal({vendorProductsDataSubmit, deleteVendorProduct, defaultCogsRowIdSubmit, productToEdit}: VendorProductsModalProps) {
    return (
        <div><p className={styles.smallDescriptionText}>
            Add vendor SKUs associated with this product.
        </p>
            <VendorProductsTable vendorProductsDataSubmit={vendorProductsDataSubmit} deleteVendorProduct={deleteVendorProduct} defaultCogsRowIdSubmit={defaultCogsRowIdSubmit} productToEdit={productToEdit}/></div>
    )
}
