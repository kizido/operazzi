...
export const getProductVendors: RequestHandler = async (req, res, next) => {
  ...
  try {
    ...
    const productVendors = await ProductVendorModel.find({
...
export const getProductVendor: RequestHandler = async (req, res, next) => {
  ...
  try {
    ...
    const productVendor = await ProductVendorModel.findById(
      productVendorId
    ).exec();
...
export const createProductVendor: RequestHandler<
  unknown,
  unknown,
  { vendor: string },
  unknown
...
export const updateProductVendor: RequestHandler<
  UpdateProductVendorParams,
  unknown,
  UpdateProductVendorBody,
  unknown
> = async (req, res, next) => {
  const productVendorId = req.params.productVendorId;
